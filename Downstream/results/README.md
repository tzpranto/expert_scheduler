...
Layer variation: The lowest entropies are around layers 3 and 13 (~5.72–5.74 bits; ~53 effective experts), indicating only a mild concentration there. The highest is around layer 10 (~5.88 bits; ~59 effective experts). The spread across layers is small, so routing remains diverse throughout.
